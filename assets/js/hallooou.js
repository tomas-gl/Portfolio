    ...
    $('.popup-gallery').magnificPopup({
        ...
        image: {
            ...
            titleSrc: function(item) {
                return item.el.attr('title') + '<small>Auteur: Tomas Gavrel</small>';
            }
        }
    });
...
$(function() {
    ...
    $("#contactForm").validate({
        ...
        messages: {
            name: {
                required: "Emplacement vide ou nom trop court",
                minlength: "2 caractères minimum",
                lettersonly: "Seulement des lettres"
            },
            email: {
            ...
            phone: {
                ...
                digits: "Seulement des numéros (pas d'espace)",
        ...
        success: function(label) {
            label.addClass("valid").text("Parfait !");
        },
