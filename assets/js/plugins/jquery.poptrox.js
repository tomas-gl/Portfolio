		...
		$.fn.poptrox = function(options) {
			...
			// Settings
				var settings = $.extend({
					...
					popupSpeed:						400,						// Popup (resize) speed
					...
					popupCloserTextSize:			'50px',						// (Default Style) Popup closer text size
					popupPadding:					10,							// (Default Style) Popup padding (when usePopupStyling = true)
					popupCaptionHeight:				60,							// (Default Style) Popup height of caption area
					popupCaptionTextSize:			null,						// (Default Style) Popup caption text size
					popupBlankCaptionText:			'(untilted)',				// Applied to images that don't have captions (when captions are enabled)
					...
					if (settings.usePopupDefaultStyling) {
						...
						if ($nav.length == 2) {
							...
							$nav_next
								.css('right', '0')
								.css('width', wn)
								.html('<div style="position: absolute; height: 100px; width: 125px; top: 50%; right: -200px; margin-top: -50px;">&gt;</div>');

							$nav_previous
								.css('left', '0')
								.css('width', wp)
								.html('<div style="position: absolute; height: 100px; width: 125px; top: 50%; left: -200px; margin-top: -50px;">&lt;</div>');
